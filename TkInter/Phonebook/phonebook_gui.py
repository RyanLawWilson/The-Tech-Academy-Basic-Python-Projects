...
def load_gui(self):
    # I didn't have to use tk.Label or tk.Entry before.  It work with just Label or Entry.
    ...
    #Define the listbox with a scrollbar and grid
    self.scrollbar1 = Scrollbar(self.master,orient=VERTICAL)
    self.lstList1 = Listbox(self.master,exportselection=0,yscrollcommand=self.scrollbar1.set)
    # Event Listener - The Event is called ListboxSelect
